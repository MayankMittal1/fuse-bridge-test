...
export type CachedSwapSavedEvent = TypedEvent<
  [number, string, BigNumber, string, BigNumber, string, string],
...
export interface Router extends BaseContract {
  ...
  filters: {
    "CachedSwapSaved(uint16,bytes,uint256,address,uint256,address,bytes)"(
      chainId?: null,
      srcAddress?: null,
      nonce?: null,
      token?: null,
    ...
    "ReceiveFailed(uint16,bytes,uint256,address,uint256,bytes,string)"(
      chainId?: null,
      srcAddress?: null,
      nonce?: null,
      token?: null,
