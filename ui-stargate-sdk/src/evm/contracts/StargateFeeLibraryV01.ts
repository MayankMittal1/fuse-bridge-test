...
export interface StargateFeeLibraryV01Interface extends utils.Interface {
  functions: {
...
export type FeesUpdatedEvent = TypedEvent<[BigNumber, BigNumber], FeesUpdatedEventObject>;
...
export interface StargateFeeLibraryV01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StargateFeeLibraryV01Interface;
